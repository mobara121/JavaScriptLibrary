        ...
        <div className="main">
            <div className="mainDiv">
                ...
                <ul>
                    ...
                    <li>Effects can return cleanup functions, which can clean up tomers using memory, listeners to outside APIs, and other functions which may use system resources.</li>
                </ul>
                <SampleEffect/>
                <br/>
                <SampleEffect/>
