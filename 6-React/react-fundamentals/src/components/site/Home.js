    ...
    return(
        ...
        <div className="mainDiv">
            ...
            <ul>
                ...
                <li>At this phase, this is not yet responsive.</li>
                <li>Refactor the text on this page and make this your own portfolio project.</li>
                <li>This app simply scratches the syrface on what is possible with React.</li>
